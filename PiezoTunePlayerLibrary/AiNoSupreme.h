...
const int AI_NO_SUPREME_TUNE[] = {
    ...
    NOTE_D5, NOTE_G5, NOTE_G5, NOTE_D5, NOTE_F5, NOTE_G5, NOTE_F5, NOTE_G5, NOTE_A5,
    NOTE_F4, NOTE_F4, NOTE_G4, NOTE_A4, NOTE_A4,
    NOTE_C6, NOTE_C6, NOTE_AS5, NOTE_AS5, NOTE_AS5, NOTE_A5, NOTE_F5, NOTE_G5, NOTE_F5, NOTE_G5, NOTE_F5
};

const float AI_NO_SUPREME_DURATIONS[] = {
    EIGHTH, EIGHTH, EIGHTH, EIGHTH,
    QUARTER, QUARTER, HALF, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, HALF,
    EIGHTH, EIGHTH, QUARTER, EIGHTH, EIGHTH,
    QUARTER, EIGHTH, QUARTER, QUARTER, EIGHTH, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, WHOLE
};
